...
which print message "The animal makes a sound".
 Write a Subclasses of Animals Pigs, Cats, and their own implementation of 
...
In a Test class, create an Animal Pig and Cat  objects and 
call the animalSound() method on them, 
